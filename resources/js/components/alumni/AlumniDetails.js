                                                    ...
                                                    {getData("current_company") && (
                                                        <Col xs={24} sm={12}>
                                                            <div className="detail-item">
                                                                ...
                                                                <Text>{getData("current_company")}</Text>
                                                            </div>
                                                        </Col>
                                                    )}
                                                    ...
                                                    {getData("work_location") && (
                                                        <Col xs={24} sm={12}>
                                                            <div className="detail-item">
                                                                ...
                                                                <Text>{getData("work_location")}</Text>
                                                            </div>
                                                        </Col>
                                                    )}
                                                    ...
                                                    {getData("employment_status") && (
                                                        <Col xs={24} sm={12}>
                                                            <div className="detail-item">
                                                                ...
                                                                <Tag color={getEmploymentStatusColor()}>
                                                                    {getEmploymentStatus()}
                                                                </Tag>
                                                            </div>
                                                        </Col>
                                            ...
                                            <div className="academic-details">
                                                <Row gutter={[16, 12]}>
                                                    ...
                                                    {getData("enrollment_year") && (
                                                        <Col xs={24} sm={12}>
                                                            <div className="detail-item">
                                                                <Text strong>Enrollment Year:</Text>
                                                                <Text>{getData("enrollment_year")}</Text>
                                                            </div>
                                                        </Col>
                                                    )}
                                                    ...
                                                    {getData("graduation_year") && (
                                                        <Col xs={24} sm={12}>
                                                            <div className="detail-item">
                                                                ...
                                                                <Text>{getData("graduation_year")}</Text>
                                                            </div>
                                                        </Col>
                                                    )}
