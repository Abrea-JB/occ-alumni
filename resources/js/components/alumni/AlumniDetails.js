                        ...
                        <div className="preview-profile-section">
                            ...
                            <div className="profile-info">
                                ...
                                <Text className="preview-title">
                                    {getData("jobTitle") || "Alumni"}
                                    {getData("currentCompany") &&
                                        ` at ${getData("currentCompany")}`}
                                </Text>
