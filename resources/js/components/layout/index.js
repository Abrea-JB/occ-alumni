        ...
        >
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              ...
              <Badge dot color={getPriorityColor(notification.priority)} size="small" style={{ marginLeft: 8 }} />
            </div>
            <Text
              style={{
                fontSize: "12px",
      ...
      >
        ...
        <div style={{ maxHeight: 200, overflowY: "auto" }}>
          {isLoading ? (
            ...
            <List dataSource={filteredNotifications} renderItem={(item) => <NotificationItem notification={item} />} />
          )}
        </div>
    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: 8 }}>
          <Badge
            status="success"
            text={userData.role.charAt(0).toUpperCase() + userData.role.slice(1)}
            style={{ fontSize: "11px" }}
          />
        </div>
      </div>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          >
            ...
            >
              ...
              >
                Required: Complete a quiz to continue using the app
              </span>
            </div>
          </div>
