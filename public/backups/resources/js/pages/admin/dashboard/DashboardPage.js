        ...
        const processAlumniData = () => {
            ...
            try {
                ...
                alumniList.forEach((alum) => {
                    ...
                    const courseName =
                       courseData.course_code || `Course ${alum.course_id}`;
                    ...
                    if (industry) {
                        industryData[industry] =
                            (industryData[industry] || 0) + 1;
                    }

                    // Process employer data
                    if (employer) {
                        employerData[employer] =
                            (employerData[employer] || 0) + 1;
                    }
                    ...
                    if (yearsExperience && salary) {
                        ...
                        if (salaryMatch && salaryMatch.length > 0) {
                            ...
                            salaryByExperience[expKey].total += avgSalary;
                ...
                Object.keys(courseEmploymentData).forEach((courseName) => {
                    ...
                    course.employmentRate =
                        course.total > 0
                            ? Math.round((course.employed / course.total) * 100)
                            : 0;
                });

                // Format course employment data for the chart
                const courseEmploymentFormatted = Object.entries(
                    courseEmploymentData
                )
                    .map(([courseName, data]) => ({
                        course: courseName,
                        total: data.total,
                        ...
                        unemployedPercentage:
                            data.total > 0
                                ? Math.round(
                                      (data.unemployed / data.total) * 100
                                  )
                                : 0,
                        underEmployedPercentage:
                            data.total > 0
                                ? Math.round(
                ...
                const currentData = [
                    ...
                    },
                    {
                        ...
                        value:
                            totalAlumni > 0
                                ? Math.round(
                                      (unemployedCount / totalAlumni) * 100
                                  )
                                : 0,
                        color: "#ff4d4f",
                    ...
                    },
                    {
                        ...
                        value:
                            totalAlumni > 0
                                ? Math.round(
                                      (underEmployedCount / totalAlumni) * 100
                                  )
                                : 0,
                        color: "#faad14",
                ...
                const trendDataFormatted = recentYears.map((year) => ({
                    ...
                    employed:
                        graduationYearData[year].total > 0
                            ? Math.round(
                                  (graduationYearData[year].employed /
                                      graduationYearData[year].total) *
                                      100
                              )
                            : 0,
                    unemployed:
                        graduationYearData[year].total > 0
                            ? Math.round(
                                  (graduationYearData[year].unemployed /
                                      graduationYearData[year].total) *
                                      100
                              )
                            : 0,
                    underEmployed:
                        graduationYearData[year].total > 0
                            ? Math.round(
                                  (graduationYearData[year].underEmployed /
                                      graduationYearData[year].total) *
                                      100
                              )
                            : 0,
                ...
                const byMajorFormatted = Object.values(byMajorData).map(
                    (data) => ({
                        major: data.name,
                        employed:
                            data.total > 0
                ...
                const salaryProgressionFormatted = Object.entries(
                    salaryByExperience
                )
                    .sort(([a], [b]) => a - b)
                    .map(([years, data]) => ({
                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        render: (_, record) => (
                            <Space>
                                <Text type="warning">
                                    {record.underEmployed}
                                </Text>
                                <Text type="secondary">
                                    ({record.underEmployedPercentage}%)
                                </Text>
                            </Space>
                        ),
                    },
        ...
        <div className="chart-container">
            ...
            <ResponsiveContainer width="100%" height={400}>
                ...
                >
                    ...
                    <Legend />
                    <Bar
                        dataKey="employedPercentage"
                        name="Employed %"
                        stackId="a"
                        fill="#32d1b3"
                    />
                    <Bar
                        dataKey="underEmployedPercentage"
                        name="Under Employed %"
                        stackId="a"
                        fill="#faad14"
                    />
                    <Bar
                        dataKey="unemployedPercentage"
                        name="Unemployed %"
                        stackId="a"
                        fill="#ff4d4f"
                    />
                ...
                <Row gutter={[24, 24]} className="metrics-row">
                    ...
                    <Col xs={24} sm={12} lg={6}>
                        <Card className="metric-card">
                            ...
                            <Rate
                                disabled
                                value={alumniMetrics?.satisfactionRate || 0}
                                allowHalf
                            />
                        </Card>
                    </Col>
